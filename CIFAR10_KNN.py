...
Original file is located at
    https://colab.research.google.com/drive/1a1EsybSw4Rm2Hy3lzt44Du3E3oh7A2ra
"""
...
grid_search = GridSearchCV(knn_model, param_grid1, cv=5, n_jobs=-1)
...
knn_results = knn_pred[:30].ravel()
yTest_results = y_test[:30].ravel()
...
"""KPCA + LDA CROSS VALIDATION METHOD"""
...
knn = KNeighborsClassifier(metric='euclidean', n_neighbors=17, weights='distance')
...
kpca = KernelPCA(n_components_95, kernel='poly', degree= 3, coef0=0.5)
X_train_kpca = kpca.fit_transform(X_train)
X_test_kpca = kpca.transform(X_test)
